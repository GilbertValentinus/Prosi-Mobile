    ...
    {routeInfo && !error && (
      <div className="flex gap-4 mt-4 bg-[#2A2F4E] p-2 rounded-lg">
        <div className="flex-1 text-center p-2">
          <span className="bg-purple-500 text-white px-3 py-1 rounded-full text-sm">🚗 {routeInfo.duration} min</span>
        </div>
        <div className="flex-1 text-center p-2">
          <span className="bg-purple-500 text-white px-3 py-1 rounded-full text-sm">📍 {routeInfo.distance} km</span>
        </div>
      </div>
    )}
  </div>
